...
public class SetUtils {
    ...
    public static <E> Set<E> symmetricDifference(Set<? extends E> s1, Set<? extends E> s2) {
        Set<E> firstWithoutSecond = new HashSet<>(difference(s1, s2));
        Set<E> secondWithoutFirst = new HashSet<>(difference(s2, s1));

        Set<E> result = new HashSet<>(union(firstWithoutSecond, secondWithoutFirst));
        return result;
    }
